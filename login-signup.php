...
<body>
    <div class="form"> 
        ...
        <div class="tab-content">
            <div id="login">   
                <h1>Welcome Back!</h1>
                <form id="loginform" action="/GlobalITBooks/login.php" method="post">
                    <div class="field-wrap">
                        <label>
                            Email Address<span class="req">*</span>
                        </label>
                        <input type="email" id="uname" required autocomplete="off">
                        <input type="hidden" id="rand" name="rand" value="<?php echo base64_encode(random_bytes(10)); ?>">
                    ...
                    <button onclick="myFunction()" class="button button-block" >Log In</button>
                </form>
            </div>
            <div id="signup">   
...
<script>
    function myFunction() {
        //document.getElementById("rand").innerHTML = "Hello World";
